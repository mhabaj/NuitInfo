...
CREATE TABLE moderate(
        idStream Int NOT NULL ,
        idUser   Int NOT NULL
	,CONSTRAINT moderate_PK PRIMARY KEY (idStream,idUser)

	,CONSTRAINT moderate_Stream_FK FOREIGN KEY (idStream) REFERENCES Stream(idStream)
	,CONSTRAINT moderate_User0_FK FOREIGN KEY (idUser) REFERENCES User(idUser)
)ENGINE=InnoDB;
